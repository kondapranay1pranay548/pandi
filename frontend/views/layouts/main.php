...
<div  id="wrapper" class="  clearfix">
		...
		<?php 
                $parent_services = MasterPoojalu::find()->with('subPoojalus','subPoojalus.remedialPujas')->limit(5)->all(); 
                $parent_services_second_men = MasterPoojalu::find()->with('subPoojalus','subPoojalus.remedialPujas')->limit(5)->offset(5)->all(); 
