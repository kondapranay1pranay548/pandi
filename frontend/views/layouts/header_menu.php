                ...
                <ul class="hidden-sm ">
                    ...
                    <li class="mega-menu"><a href="#"><div>Puja</div></a>
                        <div class="mega-menu-content style-2 clearfix">
				            ...
				            <a href="varalakshmi-vratam"><?php echo $this_month->image; ?></a>
                                            </div>
...
<!--                    <li class="mega-menu"><a href="<?php  echo Yii::$app->params['mainLink']; ?>site/contact"><div>Contact</div></a>
					...
					<?php
						...
						<li class="mega-menu current"><a href="<?php echo Yii::$app->params['mainLink']; ?>site/login"><div>login</div></a>	
						<li class="mega-menu current"><a href="<?php echo Yii::$app->params['mainLink']; ?>site/signup"><div>Signup</div></a>
						<?php } else {
							echo '<li class="mega-menu current">'
